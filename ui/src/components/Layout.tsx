...
// Medical cross inside a shield — Health vault icon
const HealthIcon = () => (
  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-3-3v6m-9 1V7a2 2 0 012-2h14a2 2 0 012 2v10c0 1.5-3 5-9 5s-9-3.5-9-5z" />
  </svg>
);
...
const SysmonIcon = () => (
  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2m-9 4h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V9a2 2 0 012-2z" />
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 14l2 2m2-2l2-2m2 2l2 2" />
  </svg>
);
...
const navItems: NavItem[] = [
  ...
  { path: '/sysmon', label: 'System Monitor', icon: SysmonIcon },
  { path: '/presentation', label: 'Presentations', icon: PresentationIcon },
];
